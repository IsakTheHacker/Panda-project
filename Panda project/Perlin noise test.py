...
#  ourselves.
noise = PerlinNoise3(100, 100, 10, 256, datetime.datetime.now().toordinal())
noise2 = PerlinNoise3(70, 70, 5, 256, datetime.datetime.now().toordinal())
noise3 = PerlinNoise3(40, 40, 2, 256, datetime.datetime.now().toordinal())
noise4 = PerlinNoise3(10, 10, 0.2, 256, datetime.datetime.now().toordinal())
